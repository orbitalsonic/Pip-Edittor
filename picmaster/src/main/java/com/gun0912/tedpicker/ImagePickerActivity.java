...
import com.gun0912.tedpicker.adapter.SpacesItemDecoration;
import com.gun0912.tedpicker.util.Util;

import java.util.ArrayList;

import test_picker.com.gun0912.pickmaster.R;
...
public class ImagePickerActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.add(R.id.gallery_fragment, galleryFragment).commit();
